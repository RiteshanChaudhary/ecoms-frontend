  ...
  return (
    <footer className="bg-gray-900 text-white py-10 px-5">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
        ...
        {/* Brand & Contact */}
        <div>
          <h2 className="text-2xl font-bold text-blue-400">e-bazzar</h2>
          <div className="mt-4 flex items-center gap-2">
            <FaPhoneAlt className="text-blue-300" />
            <span className="text-sm">+977-9703236043</span>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <MdEmail className="text-blue-300" />
            <span className="text-sm">riteshanchau15@gmail.com</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4 text-blue-400 text-2xl">
            ...
            <a href="https://wa.me/9812665589" target="_blank" rel="noopener noreferrer" className="hover:text-white">
              <FaWhatsapp />
            </a>
          </div>
        </div>
